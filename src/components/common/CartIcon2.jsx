...
export const CartIcon = ({ bgColor }) => {
    ...
    const hoverFill = "#000000"; // Couleur bleu clair pour le remplissage au survol
    ...
    return (
        ...
        >
            {!bgColor && <rect width="44" height="44" rx="8" fill="none" />}
            
            {/* Forme de fond du panier qui change de couleur au survol */}
            <path 
